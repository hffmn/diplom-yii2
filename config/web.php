...
$config = [
    ...
    'components' => [
        'request' => [
            ...
            'cookieValidationKey' => 'sdgfzsagfsrfsargfzsargf',
            'baseUrl' => ''
        ],
        'cache' => [
...
//            'loginUrl' => 'admin',
        ...
        'mailer' => [
            ...
            'transport' => [
                ...
                'host' => 'smtp.yandex.ru',
                'username' => 'romashcko.p',
                'password' => '755522Pasha',
                'port' => '465',
                'encryption' => 'ssl',
            ],
        ],
        ...
        'urlManager' => [
            ...
            'rules' => [
                ...
                'product/<id:\d+>/images/image-by-item-and-alias' => 'yii2images/images/image-by-item-and-alias',
